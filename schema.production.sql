-- TAKDARO PRODUCTION SCHEMA BASELINE
-- Source: Cloudflare D1 database takdaro-users-prod
-- Captured: 2026-09-08
-- Purpose: read-only baseline for schema-drift review.
-- DO NOT apply this file to an existing database. Use incremental migrations only.
