...
// ============================================
// نام فارسی وضعیت‌ها (۱۲ وضعیت نهایی)
// ============================================
    ...
    return json({
      ...
      order: {
        ...
        notes:
          order.notes || "",
        delivery_date:
          deliverySelection?.delivery_date || "",
        delivery_slot_id:
          deliverySelection?.delivery_slot_id || null,
        delivery_time_from:
          deliverySelection?.delivery_time_from || "",
        delivery_time_to:
          deliverySelection?.delivery_time_to || "",
        delivery_label:
          deliveryLabel,
        created_at:
...
export async function onRequestPost(context) {
  try {
    ...
    if (
      nextStatus &&
      !ALLOWED_UNIFIED_STATUSES.includes(
        nextStatus
      )
    ) {
      return json(
    ...
    // ============================================
    // برگرداندن موجودی فقط در اولین ورود به cancelled
    // ============================================
    ...
    try {
      ...
      if (finalStatus !== oldStatus) {
        if (finalStatus === "cancelled") {
          ...
          try {
            ...
            if (
              notificationResults.admin?.success
            ) {
            ...
            if (
              notificationResults.user?.success
            ) {
      ...
      // ============================================
      // اعلان کاربر برای وضعیت غیر cancelled
      // ============================================
