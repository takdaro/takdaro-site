...
import { onRequestPatch as __api_admin_orders__order__js_onRequestPatch } from "C:\\Users\\ASUS\\Documents\\takdaro-site\\functions\\api\\admin\\orders\\[order].js"
...
export const routes = [
    ...
    },
  {
      ...
      method: "PATCH",
      middlewares: [],
      modules: [__api_admin_orders__order__js_onRequestPatch],
    },
  {
      routePath: "/api/admin/orders/:order",
      mountPath: "/api/admin/orders",
