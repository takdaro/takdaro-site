...
var init_default = __esm({
  "api/account/addresses/[id]/default.js"() {
    init_functionsRoutes_0_10296850643836875();
...
async function sendOrderStatusChangedNotification(env, orderData, userData, oldStatus, newStatus) {
  ...
  if (smsSettings.is_enabled && smsSettings.event_order_status_changed_user && smsSettings.admin_phone) {
    let eventType = "order_processing";
    ...
    else eventType = "order_processing";
    const templateData = {
      customer_name: userData.fullName || "",
      customer_phone: userData.phone || "",
      order_number: orderData.orderNumber || "",
...
async function onRequestPost6(context) {
  try {
    console.log("\u{1F525}\u{1F525}\u{1F525} onRequestPost \u0627\u062C\u0631\u0627 \u0634\u062F! \u062A\u0627\u0631\u06CC\u062E: 2026-08-13");
    const user = await getCurrentUser4(context);
    if (!user || !isAdmin(user)) {
      return json11({ success: false, error: "unauthorized" }, 401);
    }
    ...
    console.log(`\u{1F4CA} \u0648\u0636\u0639\u06CC\u062A \u0646\u0647\u0627\u06CC\u06CC: "${finalStatus}"`);
    console.log(`\u{1F4CA} \u0648\u0636\u0639\u06CC\u062A \u0642\u0628\u0644\u06CC: "${oldStatus}"`);
    console.log(`\u{1F4CA} \u0622\u06CC\u0627 \u0628\u0631\u0627\u0628\u0631 \u0628\u0627 cancelled \u0627\u0633\u062A\u061F ${finalStatus === "cancelled"}`);
    await context.env.DB.prepare(`
      UPDATE orders
      SET
        status = ?,
    ...
    } else if (ALLOWED_ORDER_STATUSES.filter((s) => s !== "completed").includes(finalStatus) && String(updatedOrder.cashback_status || "").toLowerCase() === "completed") {
...
async function onRequestPost10(context) {
  try {
    ...
    if (nextStatus && !ALLOWED_ORDER_STATUSES2.includes(nextStatus)) {
      return json18({
        success: false,
        error: "invalid_order_status",
        allowed: ALLOWED_ORDER_STATUSES2
      }, 400);
    }
    if (nextPaymentStatus && !ALLOWED_PAYMENT_STATUSES2.includes(nextPaymentStatus)) {
      return json18({
        success: false,
        error: "invalid_payment_status",
        allowed: ALLOWED_PAYMENT_STATUSES2
      }, 400);
    }
...
var ALLOWED_ORDER_STATUSES2, ALLOWED_PAYMENT_STATUSES2;
...
// ../.wrangler/tmp/pages-1ayO2p/functionsRoutes-0.10296850643836875.mjs
var routes;
var init_functionsRoutes_0_10296850643836875 = __esm({
  "../.wrangler/tmp/pages-1ayO2p/functionsRoutes-0.10296850643836875.mjs"() {
    init_default();
    init_connect();
    init_disconnect();
