...
var init_default = __esm({
  "api/account/addresses/[id]/default.js"() {
    init_functionsRoutes_0_24648529275878583();
...
function productFromRow3(product, imageRows, rate) {
  ...
  let basePrice = product.base_price !== null && product.base_price !== void 0 ? Number(product.base_price) : null;
  let calculatedPrice = product.calculated_price !== null && product.calculated_price !== void 0 ? Number(product.calculated_price) : null;
...
async function onRequestGet22(context) {
  try {
    ...
    const products = productRows.map(
      (product) => productFromRow3(product, imageRows, currentRate)
    );
    return json25({
      success: true,
...
// ../.wrangler/tmp/pages-k3L4sP/functionsRoutes-0.24648529275878583.mjs
var routes;
var init_functionsRoutes_0_24648529275878583 = __esm({
  "../.wrangler/tmp/pages-k3L4sP/functionsRoutes-0.24648529275878583.mjs"() {
    init_default();
    init_password2();
    init_id();
